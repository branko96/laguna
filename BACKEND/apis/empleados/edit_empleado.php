...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$rta=$empleadosController->EditarEmpleado($body['id_empleado'],$body['nombre'],$body['apellido'],$body['puesto'],$body['sueldo'],$body['email'],$body['dni'],$body['cuil'], $body['cod_postal'], $body['fecha_fin']);
